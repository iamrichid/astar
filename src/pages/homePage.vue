<template>
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
      ...
      <div class="bg-white rounded-2xl pt-4 p-4 md:col-span-1 flex flex-col justify-start space-y-4">
      ...
      <div class=" relative col-span-1 flex  flex-col justify-start  rounded-2xl
        ...
        <div class="h-full  md:pt-16 flex-col items-start justify-start space-y-3">
      ...
      <div class="relative col-span-1 flex aspect-auto flex-col  justify-center space-y-3 rounded-2xl
              bg-blue-700 p-4  pt-4 text-base  leading-[1.12rem] text-white md:p-8 ">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-right absolute right-3 top-3 text-white">
          <path d="M7 7h10v10"></path><path d="M7 17 17 7"></path>
        </svg>
